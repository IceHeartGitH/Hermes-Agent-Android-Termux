...
system (`~/.hermes-venv/plugins/`) is otherwise documented separately.
...
- Backend: if the plugin ships a Python `plugin_api.py` (under
  `~/.hermes-venv/plugins/<id>/dashboard/`, manifest `"api": "plugin_api.py"`), reach
