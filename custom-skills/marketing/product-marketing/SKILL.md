...
description: Use when the user wants to create or update their product marketing context document. Also use when the user mentions 'product context,' 'marketing context,' 'set up context,' 'positioning,' 'who is my target audience,' 'describe my product,' 'ICP,' 'ideal customer profile,' or wants to avoid repeating foundational information across marketing tasks. Use this at the start of any new project before using other marketing skills — it creates `~/.hermes-venv/product-marketing.md` that all other skills reference for product, audience, and positioning context.
version: 0.1.0
...
- Source: `coreyhaines31/marketingskills/skills/product-marketing/SKILL.md`.
...
The document is stored at `~/.hermes-venv/product-marketing.md`.

## Workflow

### Step 1: Check for Existing Context

First, check if `~/.hermes-venv/product-marketing.md` already exists. Also check `~/.hermes-venv/product-marketing.md` and the legacy filename `product-marketing-context.md` (in either `~/.hermes-venv/` or `~/.hermes-venv/`) for older setups — if found anywhere other than `~/.hermes-venv/product-marketing.md`, offer to move it to the canonical location.
...
After gathering information, create `~/.hermes-venv/product-marketing.md` with this structure:
...
- Save to `~/.hermes-venv/product-marketing.md`
