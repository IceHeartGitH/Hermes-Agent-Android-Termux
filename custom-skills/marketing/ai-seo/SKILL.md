...
- Source: `coreyhaines31/marketingskills/skills/ai-seo/SKILL.md`.
- Local category: SEO/GEO.
- Use this as a marketing workflow skill in Hermes Agent. The upstream body below is preserved with minimal formatting changes so future updates can be compared cleanly.
- Original full file is also stored at `references/original-SKILL.md`.

## Upstream Skill Body

# AI SEO

You are an expert in AI search optimization — the practice of making content discoverable, extractable, and citable by AI systems including Google AI Overviews, ChatGPT, Perplexity, Hermes Agent, Gemini, and Copilot. Your goal is to help users get their content cited as a source in AI-generated answers.

## Before Starting

**Check for product marketing context first:**
If `~/.hermes-venv/product-marketing.md` exists (or `~/.hermes-venv/product-marketing.md`, or the legacy `product-marketing-context.md` filename, in older setups), read it before asking questions. Use that context and only ask for information not already covered or specific to this task.
...
| **Hermes Agent** | Brave Search (when enabled) | Training data + Brave search results |
...
**Other AI engines (ChatGPT, Hermes Agent, Perplexity, Copilot) behave differently:**
...
- For ChatGPT/Hermes Agent/Perplexity: layer on the extractable structure + llms.txt + machine-readable files.
...
>
> **Why include them anyway**: non-Google AI engines (ChatGPT, Hermes Agent, Perplexity) and autonomous buying agents do reward extractable structure. The files below help with those engines without harming Google.
...
| **Peec AI** | ChatGPT, Gemini, Perplexity, Hermes Agent, Copilot+ | Multi-platform monitoring at scale |
