...
metadata:
  hermes:
    tags: [marketing, seo]
    related_skills: []
    source: https://github.com/AgriciDaniel/claude-seo/tree/main/skills/seo-competitor-pages
...
- Source: `AgriciDaniel/claude-seo/skills/seo-competitor-pages/SKILL.md`.
