---
name: openseo-deslop
description: Use when removing AI-sounding patterns from SEO, marketing, technical, or business prose while keeping meaning intact; no API required.
version: 0.1.0
...
metadata:
  hermes:
    ...
    source: https://github.com/every-app/open-seo/tree/f56972639f14/.agents/skills/deslop
---
