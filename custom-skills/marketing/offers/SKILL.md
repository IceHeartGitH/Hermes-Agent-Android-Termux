...
metadata:
  hermes:
    ...
    related_skills: [copywriting, cro, launch, paywalls, pricing]
...
- Source: `coreyhaines31/marketingskills/skills/offers/SKILL.md`.
