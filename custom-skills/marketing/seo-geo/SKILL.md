...
- Source: `AgriciDaniel/claude-seo/skills/seo-geo/SKILL.md`.
...
Read `references/llmstxt-evidence.md` for the primary-source evidence (Mueller, Illyes, SE Ranking 300k-domain study, OtterlyAI server-log audit) on why `/llms.txt` is not currently a citation lever for major AI search systems. hermes-seo reports presence but assigns no citation-ranking weight.
