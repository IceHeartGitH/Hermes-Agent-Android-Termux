---
name: openseo-seo-project-setup
description: Use when setting up a practical SEO project workspace from goals, site context, competitors, and local/Search Console exports; no API required.
version: 0.1.0
...
metadata:
  hermes:
    ...
    source: https://github.com/every-app/open-seo/tree/f56972639f14/.agents/skills/seo-project-setup
---
...
5. If OpenSEO MCP is unavailable, continue in fallback mode with provided files, Search Console exports, local crawls, manual research, and clearly label missing live metrics as unknown.
