...
- Source: `coreyhaines31/marketingskills/skills/competitor-profiling/SKILL.md`.
- Local category: Competitive.
...
If `~/.hermes-venv/product-marketing.md` exists (or `~/.hermes-venv/product-marketing.md`, or the legacy `product-marketing-context.md` filename, in older setups), read it before asking questions. Use that context and only ask for information not already covered.
