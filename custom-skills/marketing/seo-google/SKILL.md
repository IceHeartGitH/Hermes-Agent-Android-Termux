...
- Source: `AgriciDaniel/claude-seo/skills/seo-google/SKILL.md`.
...
analysis (existing hermes-seo skills) and Google's real-time field data: actual
...
```bash
hermes-seo run google_auth.py --check --json
```

Config file: `~/.config/hermes-seo/google-api.json`
```json
{
...
**Script:** `hermes-seo run pagespeed_check.py <url> --json`
...
**Script:** `hermes-seo run gsc_query.py --property <property> --json`
...
**Script:** `hermes-seo run gsc_inspect.py <url> --json`
...
**Script:** `hermes-seo run gsc_inspect.py --batch <file> --json`
...
**Script:** `hermes-seo run gsc_query.py sitemaps --property <property> --json`
...
**Script:** `hermes-seo run indexing_notify.py <url> --json`
...
**Script:** `hermes-seo run indexing_notify.py --batch <file> --json`
...
**Script:** `hermes-seo run youtube_search.py search "<query>" --json`
...
**Script:** `hermes-seo run youtube_search.py video <video_id> --json`
...
**Script:** `hermes-seo run nlp_analyze.py --url <url> --json` or `--text "..."`
...
**Script:** `hermes-seo run nlp_analyze.py --url <url> --features entities --json`
...
**Script:** `hermes-seo run keyword_planner.py ideas "<seed>" --json`
...
**Script:** `hermes-seo run keyword_planner.py volume "<kw1>,<kw2>" --json`
...
**Script:** `hermes-seo run google_report.py --type <type> --data <json> --domain <domain> --format pdf`
...
2. Save JSON output to file: `hermes-seo run pagespeed_check.py <url> --json > data.json`
3. Generate report: `hermes-seo run google_report.py --type cwv-audit --data data.json --domain <domain>`
