...
metadata:
  hermes:
    ...
    related_skills: [ad-creative, ads, ai-seo, customer-research, emails, launch, marketing-ideas, onboarding, pricing, product-marketing, programmatic-seo, referrals]
...
- Source: `coreyhaines31/marketingskills/skills/marketing-plan/SKILL.md`.
...
2. **`product-marketing`** — Sets up the foundational `~/.hermes-venv/product-marketing.md` context file (positioning, ICP, voice). Read this first; Section 2 (Strategic frame) builds on it.
...
- **`product-marketing`** — Run first. Captures positioning, ICP, voice in `~/.hermes-venv/product-marketing.md` so every section of the plan references the same foundation.
