---
name: morph-ppt-3d
description: "Use when working with OfficeCLI workflows. 3D Morph PPT — extends morph-ppt with GLB model insertion, cinematographic camera, model-content layout, and enriched visual design system. Hermes adaptation: do not auto-install OfficeCLI; verify Termux binary compatibility before running OfficeCLI commands."
version: 0.1.0
...
metadata:
  hermes:
    ...
    original_path: skills/morph-ppt-3d/SKILL.md
...
- **macOS / Linux**: `download or install OfficeCLI only after explicit user approval and Termux compatibility verification`
- **Windows (PowerShell)**: `Windows PowerShell installer omitted in Hermes active skill`
