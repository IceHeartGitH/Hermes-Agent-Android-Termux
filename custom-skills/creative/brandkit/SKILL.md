...
metadata:
  hermes:
    ...
    related_skills: []
    source: https://github.com/Leonxlnx/taste-skill/tree/main/skills/brandkit
...
- Source: `Leonxlnx/taste-skill/skills/brandkit/SKILL.md`.
