...
metadata:
  hermes:
    ...
    related_skills: []
    source: https://github.com/Leonxlnx/taste-skill/tree/main/skills/imagegen-frontend-web
...
- Source: `Leonxlnx/taste-skill/skills/imagegen-frontend-web/SKILL.md`.
