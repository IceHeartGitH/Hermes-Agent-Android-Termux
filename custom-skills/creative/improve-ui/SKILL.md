---
name: improve-ui
description: "Use when reviewing or improving an existing UI through a read-only evidence-based audit that preserves product identity and produces a self-contained implementation plan."
version: 0.1.0
...
- Source: `ibelick/ui-skills` original skill `improve-ui/SKILL.md`, commit `ae74b58`.
