...
description: "Use when auditing or fixing HTML/UI accessibility: ARIA labels, keyboard navigation, focus management, color contrast, forms, dialogs, and WCAG compliance issues."
version: 0.1.0
...
- Source: `ibelick/ui-skills` original skill `fixing-accessibility/SKILL.md`, commit `ae74b58`.
