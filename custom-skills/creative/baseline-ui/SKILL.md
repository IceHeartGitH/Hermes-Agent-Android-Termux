---
name: baseline-ui
description: "Use when an existing interface needs a fast UI polish pass: spacing, hierarchy, typography, small layout fixes, and visual deslop without replacing the product identity."
version: 0.1.0
...
- Source: `ibelick/ui-skills` original skill `baseline-ui/SKILL.md`, commit `ae74b58`.
