---
name: stitch-skill
description: Use when semantic Design System Skill for Google Stitch. Generates agent-friendly DESIGN.md files that enforce premium, anti-generic UI standards — strict typography, calibrated color, asymmetric layouts, perpetual micro-motion, and hardware-accelerated performance.
version: 0.1.0
...
- Source: `Leonxlnx/taste-skill/skills/stitch-skill/SKILL.md`.
...
- Optionally: Stitch MCP Server for programmatic integration with Hermes Agent, Antigravity, or Gemini CLI
