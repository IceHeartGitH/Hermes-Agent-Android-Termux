---
name: gpt-tasteskill
description: Use when elite UX/UI & Advanced GSAP Motion Engineer. Enforces Python-driven true randomization for layout variance, strict AIDA page structure, wide editorial typography (bans 6-line wraps), gapless bento grids, strict GSAP ScrollTriggers (pinning, stacking, scrubbing), inline micro-images, and massive section spacing.
version: 0.1.0
...
- Source: `Leonxlnx/taste-skill/skills/gpt-tasteskill/SKILL.md`.
