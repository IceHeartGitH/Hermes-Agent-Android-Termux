...
metadata:
  hermes:
    ...
    related_skills: []
    source: https://github.com/Leonxlnx/taste-skill/tree/main/skills/imagegen-frontend-mobile
...
- Source: `Leonxlnx/taste-skill/skills/imagegen-frontend-mobile/SKILL.md`.
