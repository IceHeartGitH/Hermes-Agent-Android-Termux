...
description: "Use when animations stutter or UI motion needs performance review: layout thrashing, compositor-safe properties, scroll-linked motion, blur effects, and transition jank."
version: 0.1.0
...
- Source: `ibelick/ui-skills` original skill `fixing-motion-performance/SKILL.md`, commit `ae74b58`.
