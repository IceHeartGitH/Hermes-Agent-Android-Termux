---
name: banner-design
description: Use when design banners for social media, ads, website heroes, creative assets, and print. Multiple art direction options with AI-generated visuals. Actions: design, create, generate banner. Platforms: Facebook, Twitter/X, LinkedIn, YouTube, Instagram, Google Display, website hero, print. Styles: minimalist, gradient, bold typography, photo-based, illustrated, geometric, retro, glassmorphism, 3D, neon, duotone, editorial, collage. Uses ui-ux-pro-max, frontend-design, ai-artist, ai-multimodal skills.
version: 0.1.0
...
metadata:
  hermes:
    tags: [ui, ux, design]
    related_skills: [brand, design, ui-ux-pro-max]
...
- Source: `nextlevelbuilder/ui-ux-pro-max-skill original skill: banner-design/SKILL.md`.
...
2. **Generate visual elements** with `ai-artist` + `ai-multimodal` skills
   ...
   **a) Search prompt inspiration** (6000+ examples in ai-artist):
   ```bash
   python3 ~/.hermes-venv/skills/ai-artist/scripts/search.py "<banner style keywords>"
   ```

   **b) Generate with Standard model** (fast, good for backgrounds/patterns):
   ```bash
   ~/.hermes-venv/skills/.venv/bin/python3 ~/.hermes-venv/skills/ai-multimodal/scripts/gemini_batch_process.py \
...
2. **Screenshot each banner** at exact platform dimensions:
   ...
   node ~/.hermes-venv/skills/chrome-devtools/scripts/screenshot.js \
