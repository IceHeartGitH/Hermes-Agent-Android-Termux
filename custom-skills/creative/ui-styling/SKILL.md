...
metadata:
  hermes:
    tags: [ui, ux, design]
    related_skills: [brand, design, design-system]
...
- Source: `nextlevelbuilder/ui-ux-pro-max-skill original skill: ui-styling/SKILL.md`.
